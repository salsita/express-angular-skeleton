module.exports = function ( grunt ) {
        ...
        compile: {
            options: {
                data: function(dest, src) {
                    var base = path.basename(src, '.jade');
                    if (base !== 'index') {
                        return {template_id: base};
                    } else {
                        return {template_id: path.basename(path.dirname(src))};
                    }
                }
            },
            files: [
  ...
  /**
   * The `build-no-test` builds your app without running the tests suite.
   */
